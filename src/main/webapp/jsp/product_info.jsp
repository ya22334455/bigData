        ...
        <td>
            <div class="container">
                <div class="row">
                    ...
                    <form action="${pageContext.request.contextPath}/PutCartServlet" method="post">

                        <input type="hidden" name="proId" value="${requestScope.product.proId}"/>

                    <div style="margin:0 auto;width:950px;"style="float:left;">
                        <div class="col-md-6">
                            <img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${requestScope.product.proMinImg}">


                            <div class="col-md-6" style="float: right;">
                                <div><strong>${requestScope.product.proName}</strong></div>
                                <div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
                                    <div>编号：${requestScope.product.proNum}</div>
                                </div>

                                <div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${requestScope.product.shopPrice}元/份</strong> 参 考 价： <del>￥${requestScope.product.marketPrice}元/份</del>
                                </div>
                                ...
                                <div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
                                    <div style="margin:5px 0 10px 0;">${requestScope.product.proColor}</div>
                    ...
                    <div style="width:950px;margin:0 auto;">
                        ...
                        <div>
                            <%--<img src="${pageContext.request.contextPath}/${requestScope.product.proMaxImg}">--%>
                        </div>
                    </div>
